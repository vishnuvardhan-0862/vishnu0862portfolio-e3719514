...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      />
      <motion.div 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary/10 rounded-full blur-[180px]"
        animate={{
          scale: [1, 1.1, 1],
          rotate: [0, 90, 0],
        }}
      ...
      />
      <FloatingShape 
        className="absolute bottom-32 left-16 w-16 h-16 border border-primary/20 rounded-full"
        delay={2}
      />
      <FloatingShape 
        className="absolute top-1/3 right-1/4 w-12 h-12 bg-primary/10 rounded-lg"
        delay={4}
      />
      <FloatingShape 
        className="absolute bottom-1/4 right-16 w-8 h-8 bg-accent/20 rounded-full"
        delay={1}
      />
      <FloatingShape 
        className="absolute top-1/2 left-10 w-6 h-6 border border-primary/40 rotate-45"
        delay={3}
      />
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            {/* Status badge */}
            <motion.div 
              className="absolute -bottom-2 left-1/2 -translate-x-1/2 flex items-center gap-2 px-4 py-2 bg-card/90 backdrop-blur-md border border-border/50 rounded-full shadow-lg"
          ...
          <div className="text-center lg:text-left max-w-2xl">
            ...
            <motion.p 
              className="text-sm text-primary/80 font-medium mb-6"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.45, duration: 0.6 }}
            >
              B.Tech CSE (AI & ML) • CGPA: 8.8 • Final Year
            </motion.p>
            ...
            >
              ...
              Strong foundation in Python, Data Science, SQL, and Machine Learning 
              with hands-on project experience in building predictive models and AI applications.
            </motion.p>
            ...
            >
              ...
              <div className="flex gap-3">
                <a 
                  href="https://linkedin.com/in/vishnuvardhan-komakula" 
                  target="_blank" 
